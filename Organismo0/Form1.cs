    ...
    public partial class Form1 : Form
    {
        ...
        private void ayudaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (ingles)
            {
                ...
                rtbAyuda.Text += "Automatic image saver: When it is activated, a directory chooser dialog is shown in order to choose the\t\t\t\t       directory where a screen shot *.bmp image is saved at every cycle.\n\n";
